...
public class UsuarioService {
    ...
    public void eliminar(String iduser){
		...
		public void guardarProductoUsuario(String id,String idProducto) {
			...
			if(pg == null) {
				System.out.println("********* el producto guardado es null *********");
				ProductoGuardado pg1 = new ProductoGuardado();
				pg1.setIdProducto(idProducto);
				pgs.guardarProducto(pg1); 
				productos.add(pg1);
				usuario.setProductosGuardados(productos);
			}
			//productos.remove(pg);
			if(pg != null) {
				System.out.println("****** producto guardado encontrado ***** "+pg.getIdProducto());
				productos.remove(pg);
				usuario.setProductosGuardados(productos);
				System.out.println("sacamos el producto de los guardados");
